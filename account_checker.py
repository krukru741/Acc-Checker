        ...
        if response.status_code == 200:
            ...
            if account_response.status_code == 200:
                ...
                success_msg = (
                    ...
                    f"    Security:\n"
                    f"        Email Verified: {'Yes' if account_info.get('user_info', {}).get('email_v') == 1 else 'No'}\n"
                    f"        Two-Step Verify: {'Enabled' if account_info.get('user_info', {}).get('two_step_verify_enable') == 1 else 'Disabled'}\n"
                    f"        Authenticator: {'Enabled' if account_info.get('user_info', {}).get('authenticator_enable') == 1 else 'Disabled'}\n"
                    f"        Suspicious: {'Yes' if account_info.get('user_info', {}).get('suspicious') else 'No'}\n"
                    f"    Last Login:\n"
